...
namespace Bonsal_Gardent.Areas.Admin.Data
{
    ...
    public partial class Bonsal_GardentEntities : DbContext
    {
        public Bonsal_GardentEntities()
            : base("name=Bonsal_GardentEntities")
        {
        }
        ...
        public virtual ObjectResult<GetCate_Result> GetCate(Nullable<int> typeId)
        {
            var typeIdParameter = typeId.HasValue ?
                new ObjectParameter("TypeId", typeId) :
                new ObjectParameter("TypeId", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<GetCate_Result>("GetCate", typeIdParameter);
        }
